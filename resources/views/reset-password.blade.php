				...
				<div class="col-md-6 p-b-30 offset-sm-3 mx-auto">
					<form class="leave-comment">
						...
						<div class="bo4 of-hidden size15 m-b-20 login-field wow fadeInRight" data-wow-delay=".5s">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="number" placeholder="Enter Code">
						</div>
						<div class="bo4 of-hidden size15 m-b-20 login-field wow fadeInLeft" data-wow-delay=".6s">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="password" placeholder="Enter New Password">
						</div>
						<div class="bo4 of-hidden size15 m-b-20 login-field wow fadeInRight" data-wow-delay=".7s">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="password" placeholder="Repeat Password">
						</div>
						<!-- Button -->
						<div class="btncont">						
							<button class="size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4 loginbtn wow zoomIn" data-wow-delay=".9s">
									Reset
							</button>
						</div>
					</form>
